...
Одно предупреждение об отсутствуии ограничения версии для провайдера.   
Одно об объявленной, но не используемой переменной.
...
## Задача 6
Ещё не знаком с CI/CD-системами.

## Задача 7
Код проекта: https://github.com/rizl-ad/SHDEVOPS-22-HW/tree/main/terr/work-5/t7
