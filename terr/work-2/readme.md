...
## Задача 4
Не совсем понял требование "(без хардкода!!!)" - создание ВМ мы захардкодили - объявили двумя ресурсами - соответственно, output по ним также придется хардкодить, т.е. указывать для каждой ВМ отдельные строки.  
https://github.com/rizl-ad/SHDEVOPS-22-HW/blob/main/terr/work-2/outputs.tf
